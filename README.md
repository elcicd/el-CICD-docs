...
- gitRepoName: test-cicd-stationdemo
  ...
  active: true
disabledTestEnvs:
  - uat                              # List of test environments not used
...
el-CICD expects all environments to be defined before bootstrapping the system, but not all projects will need every, single test environment.  This feature allows projects to opt out of certain test environments as needed.   Only Dev and Prod are required for all projects.
...
Sealed Secrets are not a necessity, and other strategies such as a vault may be used, but el-CICD must be manually configured not install it by default.

# Automation Server Pipelines

## Project Onboarding Pipelines

### Non-prod Project Onboarding Pipeline

### Prod Project Onboarding Pipeline
...
## Failover and Multi-Region Deployments
